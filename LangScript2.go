...
func insertIntoDB(codes []ZipCode) bool {
	...
	endStatement := ` ON CONFLICT ON CONSTRAINT (ZIPCODE) DO UPDATE SET ONLY_ENGLISH_TOTAL = excluded.ONLY_ENGLISH_TOTAL, ONLY_ENGLISH_PERCENT = excluded.ONLY_ENGLISH_PERCENT, ` +
